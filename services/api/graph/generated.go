...
type ComplexityRoot struct {
	...
	FeedbackContext struct {
		ActiveGuidanceCount func(childComplexity int) int
		AgentStages         func(childComplexity int) int
		Consulted           func(childComplexity int) int
		HandoffReason       func(childComplexity int) int
		Summary             func(childComplexity int) int
		ToolsFlagged        func(childComplexity int) int
		ToolsRun            func(childComplexity int) int
	}
	...
	Mutation struct {
		...
		AddTaskRelation             func(childComplexity int, fromTaskID string, toTaskID string, kind model.TaskRelationKind) int
		...
		CreateTask                  func(childComplexity int, title string, description *string, priority *model.TaskPriority, dueAt *time.Time, startsAt *time.Time, rank *float64) int
		...
		DeleteTaskCategory          func(childComplexity int, key string) int
	...
	TaskCategory struct {
		...
		Parent        func(childComplexity int) int
		StageBindings func(childComplexity int) int
	}
...
type FeedbackRequestResolver interface {
	...
	Context(ctx context.Context, obj *model.FeedbackRequest) (*model.FeedbackContext, error)
}
type MutationResolver interface {
	CreateTask(ctx context.Context, title string, description *string, priority *model.TaskPriority, dueAt *time.Time, startsAt *time.Time, rank *float64) (*model.Task, error)
	UpdateTaskMetadata(ctx context.Context, taskID string, priority model.TaskPriority, dueAt *time.Time, startsAt *time.Time, rank *float64) (*model.Task, error)
	...
	SetTaskCategory(ctx context.Context, input model.SetTaskCategoryInput) (*model.TaskCategory, error)
	DeleteTaskCategory(ctx context.Context, key string) (bool, error)
	...
	MarkInboxRead(ctx context.Context, id string) (*model.InboxMessageState, error)
	DismissInboxMessage(ctx context.Context, id string) (*model.InboxMessageState, error)
...
type TaskResolver interface {
	...
	Category(ctx context.Context, obj *model.Task) (*model.TaskCategory, error)
	Blocked(ctx context.Context, obj *model.Task) (bool, error)
	BlockedBy(ctx context.Context, obj *model.Task) ([]*model.Task, error)
	Blocks(ctx context.Context, obj *model.Task) ([]*model.Task, error)
	Parent(ctx context.Context, obj *model.Task) (*model.Task, error)
	Subtasks(ctx context.Context, obj *model.Task) ([]*model.Task, error)
	Related(ctx context.Context, obj *model.Task) ([]*model.Task, error)
	DuplicateOf(ctx context.Context, obj *model.Task) (*model.Task, error)
	Duplicates(ctx context.Context, obj *model.Task) ([]*model.Task, error)
...
type TaskCategoryResolver interface {
	Parent(ctx context.Context, obj *model.TaskCategory) (*model.TaskCategory, error)
	Children(ctx context.Context, obj *model.TaskCategory) ([]*model.TaskCategory, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "FeedbackContext.activeGuidanceCount":
		if e.ComplexityRoot.FeedbackContext.ActiveGuidanceCount == nil {
			break
		}

		return e.ComplexityRoot.FeedbackContext.ActiveGuidanceCount(childComplexity), true
	case "FeedbackContext.agentStages":
		if e.ComplexityRoot.FeedbackContext.AgentStages == nil {
			break
		}

		return e.ComplexityRoot.FeedbackContext.AgentStages(childComplexity), true
	case "FeedbackContext.consulted":
		if e.ComplexityRoot.FeedbackContext.Consulted == nil {
			break
		}

		return e.ComplexityRoot.FeedbackContext.Consulted(childComplexity), true
	case "FeedbackContext.handoffReason":
		if e.ComplexityRoot.FeedbackContext.HandoffReason == nil {
			break
		}

		return e.ComplexityRoot.FeedbackContext.HandoffReason(childComplexity), true
	case "FeedbackContext.summary":
		if e.ComplexityRoot.FeedbackContext.Summary == nil {
			break
		}

		return e.ComplexityRoot.FeedbackContext.Summary(childComplexity), true
	case "FeedbackContext.toolsFlagged":
		if e.ComplexityRoot.FeedbackContext.ToolsFlagged == nil {
			break
		}

		return e.ComplexityRoot.FeedbackContext.ToolsFlagged(childComplexity), true
	case "FeedbackContext.toolsRun":
		if e.ComplexityRoot.FeedbackContext.ToolsRun == nil {
			break
		}

		return e.ComplexityRoot.FeedbackContext.ToolsRun(childComplexity), true
	...
	case "FeedbackRequest.context":
		if e.ComplexityRoot.FeedbackRequest.Context == nil {
			break
		}

		return e.ComplexityRoot.FeedbackRequest.Context(childComplexity), true
	...
	case "InboxEntry.dismissedAt":
		if e.ComplexityRoot.InboxEntry.DismissedAt == nil {
			break
		}

		return e.ComplexityRoot.InboxEntry.DismissedAt(childComplexity), true
	case "InboxEntry.id":
	...
	case "InboxEntry.messageType":
		if e.ComplexityRoot.InboxEntry.MessageType == nil {
			break
		}

		return e.ComplexityRoot.InboxEntry.MessageType(childComplexity), true
	case "InboxEntry.readAt":
		if e.ComplexityRoot.InboxEntry.ReadAt == nil {
			break
		}

		return e.ComplexityRoot.InboxEntry.ReadAt(childComplexity), true
	...
	case "InboxMessageState.dismissedAt":
		if e.ComplexityRoot.InboxMessageState.DismissedAt == nil {
			break
		}

		return e.ComplexityRoot.InboxMessageState.DismissedAt(childComplexity), true
	case "InboxMessageState.id":
		if e.ComplexityRoot.InboxMessageState.ID == nil {
			break
		}

		return e.ComplexityRoot.InboxMessageState.ID(childComplexity), true
	case "InboxMessageState.readAt":
		if e.ComplexityRoot.InboxMessageState.ReadAt == nil {
			break
		}

		return e.ComplexityRoot.InboxMessageState.ReadAt(childComplexity), true
	case "InboxMessageState.seenAt":
		if e.ComplexityRoot.InboxMessageState.SeenAt == nil {
			break
		}

		return e.ComplexityRoot.InboxMessageState.SeenAt(childComplexity), true
	...
	case "Mutation.addTaskRelation":
		if e.ComplexityRoot.Mutation.AddTaskRelation == nil {
			break
		}

		args, err := ec.field_Mutation_addTaskRelation_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Mutation.AddTaskRelation(childComplexity, args["fromTaskId"].(string), args["toTaskId"].(string), args["kind"].(model.TaskRelationKind)), true
	...
	case "Mutation.createTask":
		...
		return e.ComplexityRoot.Mutation.CreateTask(childComplexity, args["title"].(string), args["description"].(*string), args["priority"].(*model.TaskPriority), args["dueAt"].(*time.Time), args["startsAt"].(*time.Time), args["rank"].(*float64)), true
	...
	case "Mutation.deleteTaskCategory":
		if e.ComplexityRoot.Mutation.DeleteTaskCategory == nil {
			break
		}
		...
		return e.ComplexityRoot.Mutation.DeleteTaskCategory(childComplexity, args["key"].(string)), true
	...
	case "Mutation.dismissInboxMessage":
		if e.ComplexityRoot.Mutation.DismissInboxMessage == nil {
			break
		}

		args, err := ec.field_Mutation_dismissInboxMessage_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Mutation.DismissInboxMessage(childComplexity, args["id"].(string)), true
	...
	case "Mutation.markInboxRead":
		if e.ComplexityRoot.Mutation.MarkInboxRead == nil {
			break
		}

		args, err := ec.field_Mutation_markInboxRead_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Mutation.MarkInboxRead(childComplexity, args["id"].(string)), true
	...
	case "Mutation.removeTaskRelation":
		...
		args, err := ec.field_Mutation_removeTaskRelation_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Mutation.RemoveTaskRelation(childComplexity, args["fromTaskId"].(string), args["toTaskId"].(string), args["kind"].(model.TaskRelationKind)), true
	...
	case "Mutation.setTaskCategory":
		if e.ComplexityRoot.Mutation.SetTaskCategory == nil {
			break
		}

		args, err := ec.field_Mutation_setTaskCategory_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Mutation.SetTaskCategory(childComplexity, args["input"].(model.SetTaskCategoryInput)), true
	...
	case "Mutation.updateTaskMetadata":
		...
		return e.ComplexityRoot.Mutation.UpdateTaskMetadata(childComplexity, args["taskId"].(string), args["priority"].(model.TaskPriority), args["dueAt"].(*time.Time), args["startsAt"].(*time.Time), args["rank"].(*float64)), true
	...
	case "Task.blocked":
		if e.ComplexityRoot.Task.Blocked == nil {
			break
		}

		return e.ComplexityRoot.Task.Blocked(childComplexity), true
	case "Task.blockedBy":
		if e.ComplexityRoot.Task.BlockedBy == nil {
			break
		}

		return e.ComplexityRoot.Task.BlockedBy(childComplexity), true
	case "Task.blocks":
		if e.ComplexityRoot.Task.Blocks == nil {
			break
		}

		return e.ComplexityRoot.Task.Blocks(childComplexity), true
	case "Task.category":
	...
	case "Task.duplicateOf":
		if e.ComplexityRoot.Task.DuplicateOf == nil {
			break
		}

		return e.ComplexityRoot.Task.DuplicateOf(childComplexity), true
	case "Task.duplicates":
		if e.ComplexityRoot.Task.Duplicates == nil {
			break
		}

		return e.ComplexityRoot.Task.Duplicates(childComplexity), true
	case "Task.editedAt":
	...
	case "Task.rank":
		if e.ComplexityRoot.Task.Rank == nil {
			break
		}

		return e.ComplexityRoot.Task.Rank(childComplexity), true
	case "Task.related":
		if e.ComplexityRoot.Task.Related == nil {
			break
		}

		return e.ComplexityRoot.Task.Related(childComplexity), true
	case "Task.shortId":
	...
	case "Task.startsAt":
		if e.ComplexityRoot.Task.StartsAt == nil {
			break
		}

		return e.ComplexityRoot.Task.StartsAt(childComplexity), true
	case "Task.state":
	...
	case "TaskCategory.children":
		if e.ComplexityRoot.TaskCategory.Children == nil {
			break
		}

		return e.ComplexityRoot.TaskCategory.Children(childComplexity), true
	case "TaskCategory.description":
		if e.ComplexityRoot.TaskCategory.Description == nil {
			break
		}

		return e.ComplexityRoot.TaskCategory.Description(childComplexity), true
	case "TaskCategory.key":
		if e.ComplexityRoot.TaskCategory.Key == nil {
			break
		}

		return e.ComplexityRoot.TaskCategory.Key(childComplexity), true
	case "TaskCategory.label":
		if e.ComplexityRoot.TaskCategory.Label == nil {
			break
		}

		return e.ComplexityRoot.TaskCategory.Label(childComplexity), true
	case "TaskCategory.parent":
		if e.ComplexityRoot.TaskCategory.Parent == nil {
			break
		}

		return e.ComplexityRoot.TaskCategory.Parent(childComplexity), true
	case "TaskCategory.stageBindings":
		if e.ComplexityRoot.TaskCategory.StageBindings == nil {
			break
		}

		return e.ComplexityRoot.TaskCategory.StageBindings(childComplexity), true
	...
	case "TaskRelation.createdAt":
		if e.ComplexityRoot.TaskRelation.CreatedAt == nil {
			break
		}

		return e.ComplexityRoot.TaskRelation.CreatedAt(childComplexity), true
	case "TaskRelation.from":
		if e.ComplexityRoot.TaskRelation.From == nil {
			break
		}

		return e.ComplexityRoot.TaskRelation.From(childComplexity), true
	case "TaskRelation.id":
		if e.ComplexityRoot.TaskRelation.ID == nil {
			break
		}

		return e.ComplexityRoot.TaskRelation.ID(childComplexity), true
	case "TaskRelation.kind":
		if e.ComplexityRoot.TaskRelation.Kind == nil {
			break
		}

		return e.ComplexityRoot.TaskRelation.Kind(childComplexity), true
	case "TaskRelation.to":
		if e.ComplexityRoot.TaskRelation.To == nil {
			break
		}

		return e.ComplexityRoot.TaskRelation.To(childComplexity), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		ec.unmarshalInputSetTaskCategoryInput,
	)
	first := true
...
func (ec *executionContext) childFields_FeedbackContext(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "toolsRun":
		return ec.fieldContext_FeedbackContext_toolsRun(ctx, field)
	case "toolsFlagged":
		return ec.fieldContext_FeedbackContext_toolsFlagged(ctx, field)
	case "agentStages":
		return ec.fieldContext_FeedbackContext_agentStages(ctx, field)
	case "handoffReason":
		return ec.fieldContext_FeedbackContext_handoffReason(ctx, field)
	case "activeGuidanceCount":
		return ec.fieldContext_FeedbackContext_activeGuidanceCount(ctx, field)
	case "consulted":
		return ec.fieldContext_FeedbackContext_consulted(ctx, field)
	case "summary":
		return ec.fieldContext_FeedbackContext_summary(ctx, field)
	}
	return nil, fmt.Errorf("no field named %q was found under type FeedbackContext", field.Name)
}
...
func (ec *executionContext) childFields_FeedbackRequest(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	...
	case "context":
		return ec.fieldContext_FeedbackRequest_context(ctx, field)
	}
...
func (ec *executionContext) childFields_InboxEntry(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	...
	case "messageType":
		return ec.fieldContext_InboxEntry_messageType(ctx, field)
	case "createdAt":
		return ec.fieldContext_InboxEntry_createdAt(ctx, field)
	case "urgency":
		return ec.fieldContext_InboxEntry_urgency(ctx, field)
	case "readAt":
		return ec.fieldContext_InboxEntry_readAt(ctx, field)
	case "dismissedAt":
		return ec.fieldContext_InboxEntry_dismissedAt(ctx, field)
	case "item":
...
func (ec *executionContext) childFields_InboxMessageState(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "id":
		return ec.fieldContext_InboxMessageState_id(ctx, field)
	case "seenAt":
		return ec.fieldContext_InboxMessageState_seenAt(ctx, field)
	case "readAt":
		return ec.fieldContext_InboxMessageState_readAt(ctx, field)
	case "dismissedAt":
...
func (ec *executionContext) childFields_Task(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	...
	case "startsAt":
		return ec.fieldContext_Task_startsAt(ctx, field)
	case "rank":
	...
	case "blockedBy":
		return ec.fieldContext_Task_blockedBy(ctx, field)
	case "blocks":
	...
	case "related":
		return ec.fieldContext_Task_related(ctx, field)
	case "duplicateOf":
		return ec.fieldContext_Task_duplicateOf(ctx, field)
	case "duplicates":
		return ec.fieldContext_Task_duplicates(ctx, field)
	case "stageSlots":
...
func (ec *executionContext) childFields_TaskCategory(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "key":
		return ec.fieldContext_TaskCategory_key(ctx, field)
	case "label":
		return ec.fieldContext_TaskCategory_label(ctx, field)
	case "description":
		return ec.fieldContext_TaskCategory_description(ctx, field)
	case "parent":
		return ec.fieldContext_TaskCategory_parent(ctx, field)
	case "children":
		return ec.fieldContext_TaskCategory_children(ctx, field)
	case "stageBindings":
		return ec.fieldContext_TaskCategory_stageBindings(ctx, field)
	}
	return nil, fmt.Errorf("no field named %q was found under type TaskCategory", field.Name)
}
...
func (ec *executionContext) childFields_TaskRelation(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "id":
		return ec.fieldContext_TaskRelation_id(ctx, field)
	case "kind":
		return ec.fieldContext_TaskRelation_kind(ctx, field)
	case "from":
		return ec.fieldContext_TaskRelation_from(ctx, field)
	case "to":
		return ec.fieldContext_TaskRelation_to(ctx, field)
	case "createdAt":
		return ec.fieldContext_TaskRelation_createdAt(ctx, field)
	}
	return nil, fmt.Errorf("no field named %q was found under type TaskRelation", field.Name)
}
...
func (ec *executionContext) field_Mutation_addTaskRelation_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "fromTaskId",
		func(ctx context.Context, v any) (string, error) {
			return ec.unmarshalNID2string(ctx, v)
		})
	if err != nil {
	...
	args["fromTaskId"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "toTaskId",
		func(ctx context.Context, v any) (string, error) {
			return ec.unmarshalNID2string(ctx, v)
		})
	if err != nil {
	...
	arg2, err := graphql.ProcessArgField(ctx, rawArgs, "kind",
		func(ctx context.Context, v any) (model.TaskRelationKind, error) {
			return ec.unmarshalNTaskRelationKind2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskRelationKind(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_createTask_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["dueAt"] = arg3
	arg4, err := graphql.ProcessArgField(ctx, rawArgs, "startsAt",
		func(ctx context.Context, v any) (*time.Time, error) {
			return ec.unmarshalOTime2ᚖtimeᚐTime(ctx, v)
		})
	if err != nil {
	...
	args["startsAt"] = arg4
	arg5, err := graphql.ProcessArgField(ctx, rawArgs, "rank",
...
func (ec *executionContext) field_Mutation_deleteTaskCategory_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "key",
		func(ctx context.Context, v any) (string, error) {
...
func (ec *executionContext) field_Mutation_dismissInboxMessage_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
...
func (ec *executionContext) field_Mutation_markInboxRead_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "id",
		func(ctx context.Context, v any) (string, error) {
...
func (ec *executionContext) field_Mutation_removeTaskRelation_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "fromTaskId",
		func(ctx context.Context, v any) (string, error) {
...
func (ec *executionContext) field_Mutation_setTaskCategory_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input",
		func(ctx context.Context, v any) (model.SetTaskCategoryInput, error) {
			return ec.unmarshalNSetTaskCategoryInput2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐSetTaskCategoryInput(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_updateTaskMetadata_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["dueAt"] = arg2
	arg3, err := graphql.ProcessArgField(ctx, rawArgs, "startsAt",
		func(ctx context.Context, v any) (*time.Time, error) {
			return ec.unmarshalOTime2ᚖtimeᚐTime(ctx, v)
		})
	if err != nil {
	...
	args["startsAt"] = arg3
	arg4, err := graphql.ProcessArgField(ctx, rawArgs, "rank",
		func(ctx context.Context, v any) (*float64, error) {
			return ec.unmarshalOFloat2ᚖfloat64(ctx, v)
		})
	if err != nil {
...
func (ec *executionContext) _FeedbackContext_toolsRun(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackContext) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_FeedbackContext_toolsRun(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("FeedbackContext", field, false, false, errors.New("field of type Int does not have child fields"))
}

func (ec *executionContext) _FeedbackContext_toolsFlagged(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackContext) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_FeedbackContext_toolsFlagged(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("FeedbackContext", field, false, false, errors.New("field of type Int does not have child fields"))
}

func (ec *executionContext) _FeedbackContext_agentStages(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackContext) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_FeedbackContext_agentStages(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("FeedbackContext", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _FeedbackContext_handoffReason(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackContext) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_FeedbackContext_handoffReason(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("FeedbackContext", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _FeedbackContext_activeGuidanceCount(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackContext) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return obj.ActiveGuidanceCount, nil
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v int) graphql.Marshaler {
			return ec.marshalNInt2int(ctx, selections, v)
...
func (ec *executionContext) fieldContext_FeedbackContext_activeGuidanceCount(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("FeedbackContext", field, false, false, errors.New("field of type Int does not have child fields"))
}

func (ec *executionContext) _FeedbackContext_consulted(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackContext) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_FeedbackContext_consulted(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("FeedbackContext", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _FeedbackContext_summary(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackContext) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_FeedbackContext_summary(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("FeedbackContext", field, false, false, errors.New("field of type String does not have child fields"))
}
...
func (ec *executionContext) _FeedbackRequest_context(ctx context.Context, field graphql.CollectedField, obj *model.FeedbackRequest) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.FeedbackRequest().Context(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.FeedbackContext) graphql.Marshaler {
			return ec.marshalOFeedbackContext2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐFeedbackContext(ctx, selections, v)
		},
		true,
		false,
	)
}
func (ec *executionContext) fieldContext_FeedbackRequest_context(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "FeedbackRequest",
		Field:      field,
		IsMethod:   true,
		IsResolver: true,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.childFields_FeedbackContext(ctx, field)
		},
	}
	return fc, nil
}
...
func (ec *executionContext) _InboxEntry_messageType(ctx context.Context, field graphql.CollectedField, obj *model.InboxEntry) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_InboxEntry_messageType(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("InboxEntry", field, false, false, errors.New("field of type String does not have child fields"))
}
...
func (ec *executionContext) _InboxEntry_readAt(ctx context.Context, field graphql.CollectedField, obj *model.InboxEntry) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_InboxEntry_readAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("InboxEntry", field, false, false, errors.New("field of type Time does not have child fields"))
}

func (ec *executionContext) _InboxEntry_dismissedAt(ctx context.Context, field graphql.CollectedField, obj *model.InboxEntry) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_InboxEntry_dismissedAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("InboxEntry", field, false, false, errors.New("field of type Time does not have child fields"))
}
...
func (ec *executionContext) _InboxMessageState_id(ctx context.Context, field graphql.CollectedField, obj *model.InboxMessageState) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_InboxMessageState_id(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("InboxMessageState", field, false, false, errors.New("field of type ID does not have child fields"))
}

func (ec *executionContext) _InboxMessageState_seenAt(ctx context.Context, field graphql.CollectedField, obj *model.InboxMessageState) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_InboxMessageState_seenAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("InboxMessageState", field, false, false, errors.New("field of type Time does not have child fields"))
}

func (ec *executionContext) _InboxMessageState_readAt(ctx context.Context, field graphql.CollectedField, obj *model.InboxMessageState) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_InboxMessageState_readAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("InboxMessageState", field, false, false, errors.New("field of type Time does not have child fields"))
}

func (ec *executionContext) _InboxMessageState_dismissedAt(ctx context.Context, field graphql.CollectedField, obj *model.InboxMessageState) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_InboxMessageState_dismissedAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("InboxMessageState", field, false, false, errors.New("field of type Time does not have child fields"))
}
...
func (ec *executionContext) _Mutation_createTask(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			...
			return ec.Resolvers.Mutation().CreateTask(ctx, fc.Args["title"].(string), fc.Args["description"].(*string), fc.Args["priority"].(*model.TaskPriority), fc.Args["dueAt"].(*time.Time), fc.Args["startsAt"].(*time.Time), fc.Args["rank"].(*float64))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Task) graphql.Marshaler {
			return ec.marshalNTask2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTask(ctx, selections, v)
...
func (ec *executionContext) _Mutation_updateTaskMetadata(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().UpdateTaskMetadata(ctx, fc.Args["taskId"].(string), fc.Args["priority"].(model.TaskPriority), fc.Args["dueAt"].(*time.Time), fc.Args["startsAt"].(*time.Time), fc.Args["rank"].(*float64))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Task) graphql.Marshaler {
			return ec.marshalNTask2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTask(ctx, selections, v)
...
func (ec *executionContext) _Mutation_setTaskCategory(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_setTaskCategory(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().SetTaskCategory(ctx, fc.Args["input"].(model.SetTaskCategoryInput))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.TaskCategory) graphql.Marshaler {
			return ec.marshalNTaskCategory2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategory(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_Mutation_setTaskCategory(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
		IsResolver: true,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.childFields_TaskCategory(ctx, field)
		},
	}
	defer func() {
		if r := recover(); r != nil {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_setTaskCategory_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_deleteTaskCategory(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_deleteTaskCategory(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().DeleteTaskCategory(ctx, fc.Args["key"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v bool) graphql.Marshaler {
			return ec.marshalNBoolean2bool(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Mutation_deleteTaskCategory(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_deleteTaskCategory_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_addTaskRelation(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_addTaskRelation(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().AddTaskRelation(ctx, fc.Args["fromTaskId"].(string), fc.Args["toTaskId"].(string), fc.Args["kind"].(model.TaskRelationKind))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.TaskRelation) graphql.Marshaler {
			return ec.marshalNTaskRelation2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskRelation(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_Mutation_addTaskRelation(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
		IsResolver: true,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.childFields_TaskRelation(ctx, field)
		},
	}
	defer func() {
		if r := recover(); r != nil {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_addTaskRelation_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_removeTaskRelation(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_removeTaskRelation(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().RemoveTaskRelation(ctx, fc.Args["fromTaskId"].(string), fc.Args["toTaskId"].(string), fc.Args["kind"].(model.TaskRelationKind))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v bool) graphql.Marshaler {
			return ec.marshalNBoolean2bool(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Mutation_removeTaskRelation(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_removeTaskRelation_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_markInboxRead(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_markInboxRead(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().MarkInboxRead(ctx, fc.Args["id"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.InboxMessageState) graphql.Marshaler {
			return ec.marshalNInboxMessageState2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐInboxMessageState(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_Mutation_markInboxRead(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
		IsResolver: true,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.childFields_InboxMessageState(ctx, field)
		},
	}
	defer func() {
		if r := recover(); r != nil {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_markInboxRead_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_dismissInboxMessage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_dismissInboxMessage(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().DismissInboxMessage(ctx, fc.Args["id"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.InboxMessageState) graphql.Marshaler {
			return ec.marshalNInboxMessageState2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐInboxMessageState(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Mutation_dismissInboxMessage(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_dismissInboxMessage_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_categories(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.TaskCategory) graphql.Marshaler {
			return ec.marshalNTaskCategory2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategoryᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Task_startsAt(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Task_startsAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Task", field, false, false, errors.New("field of type Time does not have child fields"))
}

func (ec *executionContext) _Task_rank(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Task_rank(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) _Task_category(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.TaskCategory) graphql.Marshaler {
			return ec.marshalOTaskCategory2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategory(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Task_blocked(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().Blocked(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v bool) graphql.Marshaler {
			return ec.marshalNBoolean2bool(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Task_blocked(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Task", field, true, true, errors.New("field of type Boolean does not have child fields"))
}

func (ec *executionContext) _Task_blockedBy(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().BlockedBy(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Task) graphql.Marshaler {
			return ec.marshalNTask2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskᚄ(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_Task_blockedBy(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Task",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Task_blocks(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().Blocks(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Task) graphql.Marshaler {
			return ec.marshalNTask2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskᚄ(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Task_blocks(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Task",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Task_parent(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().Parent(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Task) graphql.Marshaler {
			return ec.marshalOTask2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTask(ctx, selections, v)
...
func (ec *executionContext) _Task_subtasks(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().Subtasks(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Task) graphql.Marshaler {
			return ec.marshalNTask2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskᚄ(ctx, selections, v)
...
func (ec *executionContext) _Task_related(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().Related(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Task) graphql.Marshaler {
			return ec.marshalNTask2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskᚄ(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Task_related(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Task",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Task_duplicateOf(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().DuplicateOf(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Task) graphql.Marshaler {
			return ec.marshalOTask2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTask(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Task_duplicateOf(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Task",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Task_duplicates(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Task().Duplicates(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Task) graphql.Marshaler {
			return ec.marshalNTask2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskᚄ(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Task_duplicates(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Task",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _TaskCategory_key(ctx context.Context, field graphql.CollectedField, obj *model.TaskCategory) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskCategory_key(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TaskCategory", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _TaskCategory_label(ctx context.Context, field graphql.CollectedField, obj *model.TaskCategory) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskCategory_label(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TaskCategory", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _TaskCategory_description(ctx context.Context, field graphql.CollectedField, obj *model.TaskCategory) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskCategory_description(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TaskCategory", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _TaskCategory_parent(ctx context.Context, field graphql.CollectedField, obj *model.TaskCategory) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.TaskCategory().Parent(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.TaskCategory) graphql.Marshaler {
			return ec.marshalOTaskCategory2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategory(ctx, selections, v)
...
func (ec *executionContext) fieldContext_TaskCategory_parent(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "TaskCategory",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _TaskCategory_children(ctx context.Context, field graphql.CollectedField, obj *model.TaskCategory) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.TaskCategory().Children(ctx, obj)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.TaskCategory) graphql.Marshaler {
			return ec.marshalNTaskCategory2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategoryᚄ(ctx, selections, v)
...
func (ec *executionContext) fieldContext_TaskCategory_children(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "TaskCategory",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _TaskCategory_stageBindings(ctx context.Context, field graphql.CollectedField, obj *model.TaskCategory) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskCategory_stageBindings(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TaskCategory", field, false, false, errors.New("field of type JSON does not have child fields"))
}
...
func (ec *executionContext) _TaskRelation_id(ctx context.Context, field graphql.CollectedField, obj *model.TaskRelation) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskRelation_id(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TaskRelation", field, false, false, errors.New("field of type ID does not have child fields"))
}

func (ec *executionContext) _TaskRelation_kind(ctx context.Context, field graphql.CollectedField, obj *model.TaskRelation) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v model.TaskRelationKind) graphql.Marshaler {
			return ec.marshalNTaskRelationKind2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskRelationKind(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_TaskRelation_kind(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TaskRelation", field, false, false, errors.New("field of type TaskRelationKind does not have child fields"))
}

func (ec *executionContext) _TaskRelation_from(ctx context.Context, field graphql.CollectedField, obj *model.TaskRelation) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskRelation_from(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "TaskRelation",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _TaskRelation_to(ctx context.Context, field graphql.CollectedField, obj *model.TaskRelation) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskRelation_to(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "TaskRelation",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _TaskRelation_createdAt(ctx context.Context, field graphql.CollectedField, obj *model.TaskRelation) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_TaskRelation_createdAt(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TaskRelation", field, false, false, errors.New("field of type Time does not have child fields"))
}
...
func (ec *executionContext) unmarshalInputSetTaskCategoryInput(ctx context.Context, obj any) (model.SetTaskCategoryInput, error) {
	var it model.SetTaskCategoryInput
	if obj == nil {
		return it, nil
	}
	...
	fieldsInOrder := [...]string{"key", "label", "description", "parent", "stageBindings"}
	for _, k := range fieldsInOrder {
		...
		case "parent":
			...
			it.Parent = data
		case "stageBindings":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("stageBindings"))
			data, err := ec.unmarshalOJSON2map(ctx, v)
			if err != nil {
				return it, err
			}
			it.StageBindings = data
		}
	}
	return it, nil
}
...
var feedbackContextImplementors = []string{"FeedbackContext"}

func (ec *executionContext) _FeedbackContext(ctx context.Context, sel ast.SelectionSet, obj *model.FeedbackContext) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, feedbackContextImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("FeedbackContext")
		case "toolsRun":
			out.Values[i] = ec._FeedbackContext_toolsRun(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "toolsFlagged":
			out.Values[i] = ec._FeedbackContext_toolsFlagged(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "agentStages":
			out.Values[i] = ec._FeedbackContext_agentStages(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "handoffReason":
			out.Values[i] = ec._FeedbackContext_handoffReason(ctx, field, obj)
		case "activeGuidanceCount":
			out.Values[i] = ec._FeedbackContext_activeGuidanceCount(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "consulted":
			out.Values[i] = ec._FeedbackContext_consulted(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "summary":
			out.Values[i] = ec._FeedbackContext_summary(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
	...
	for i, field := range fields {
		...
		case "context":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._FeedbackRequest_context(ctx, field, obj)
				return res
			}
...
func (ec *executionContext) _InboxEntry(ctx context.Context, sel ast.SelectionSet, obj *model.InboxEntry) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "messageType":
			out.Values[i] = ec._InboxEntry_messageType(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "createdAt":
		...
		case "readAt":
			out.Values[i] = ec._InboxEntry_readAt(ctx, field, obj)
		case "dismissedAt":
			out.Values[i] = ec._InboxEntry_dismissedAt(ctx, field, obj)
		case "item":
...
var inboxMessageStateImplementors = []string{"InboxMessageState"}

func (ec *executionContext) _InboxMessageState(ctx context.Context, sel ast.SelectionSet, obj *model.InboxMessageState) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, inboxMessageStateImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("InboxMessageState")
		case "id":
			out.Values[i] = ec._InboxMessageState_id(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "seenAt":
			out.Values[i] = ec._InboxMessageState_seenAt(ctx, field, obj)
		case "readAt":
			out.Values[i] = ec._InboxMessageState_readAt(ctx, field, obj)
		case "dismissedAt":
			out.Values[i] = ec._InboxMessageState_dismissedAt(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "setTaskCategory":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_setTaskCategory(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "deleteTaskCategory":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_deleteTaskCategory(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		...
		case "addTaskRelation":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_addTaskRelation(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "removeTaskRelation":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_removeTaskRelation(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		...
		case "markInboxRead":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_markInboxRead(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "dismissInboxMessage":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_dismissInboxMessage(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
...
func (ec *executionContext) _Task(ctx context.Context, sel ast.SelectionSet, obj *model.Task) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "startsAt":
			out.Values[i] = ec._Task_startsAt(ctx, field, obj)
		case "rank":
			out.Values[i] = ec._Task_rank(ctx, field, obj)
		case "provenance":
		...
		case "blocked":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Task_blocked(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
		...
		case "blockedBy":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Task_blockedBy(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
		...
		case "blocks":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Task_blocks(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
		...
		case "related":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Task_related(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
		...
		case "duplicateOf":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Task_duplicateOf(ctx, field, obj)
				return res
			}
		...
		case "duplicates":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Task_duplicates(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) _TaskCategory(ctx context.Context, sel ast.SelectionSet, obj *model.TaskCategory) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "key":
			out.Values[i] = ec._TaskCategory_key(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		case "label":
			out.Values[i] = ec._TaskCategory_label(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		case "description":
			out.Values[i] = ec._TaskCategory_description(ctx, field, obj)
		case "parent":
			field := field
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._TaskCategory_parent(ctx, field, obj)
				return res
			}
		...
		case "children":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._TaskCategory_children(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
			...
			out.Concurrently(i, func(ctx context.Context) graphql.Marshaler { return innerFunc(ctx, out) })
		case "stageBindings":
			out.Values[i] = ec._TaskCategory_stageBindings(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		default:
...
var taskRelationImplementors = []string{"TaskRelation"}

func (ec *executionContext) _TaskRelation(ctx context.Context, sel ast.SelectionSet, obj *model.TaskRelation) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, taskRelationImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("TaskRelation")
		case "id":
			out.Values[i] = ec._TaskRelation_id(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "kind":
			out.Values[i] = ec._TaskRelation_kind(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "from":
			out.Values[i] = ec._TaskRelation_from(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "to":
			out.Values[i] = ec._TaskRelation_to(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "createdAt":
			out.Values[i] = ec._TaskRelation_createdAt(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) marshalNInboxMessageState2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐInboxMessageState(ctx context.Context, sel ast.SelectionSet, v model.InboxMessageState) graphql.Marshaler {
	return ec._InboxMessageState(ctx, sel, &v)
}

func (ec *executionContext) marshalNInboxMessageState2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐInboxMessageState(ctx context.Context, sel ast.SelectionSet, v *model.InboxMessageState) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNSetTaskCategoryInput2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐSetTaskCategoryInput(ctx context.Context, v any) (model.SetTaskCategoryInput, error) {
	res, err := ec.unmarshalInputSetTaskCategoryInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) marshalNTask2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Task) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTask2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTask(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTaskCategory2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategory(ctx context.Context, sel ast.SelectionSet, v model.TaskCategory) graphql.Marshaler {
	return ec._TaskCategory(ctx, sel, &v)
}

func (ec *executionContext) marshalNTaskCategory2ᚕᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategoryᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.TaskCategory) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTaskCategory2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategory(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTaskCategory2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategory(ctx context.Context, sel ast.SelectionSet, v *model.TaskCategory) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNTaskRelation2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskRelation(ctx context.Context, sel ast.SelectionSet, v model.TaskRelation) graphql.Marshaler {
	return ec._TaskRelation(ctx, sel, &v)
}

func (ec *executionContext) marshalNTaskRelation2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskRelation(ctx context.Context, sel ast.SelectionSet, v *model.TaskRelation) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNTaskRelationKind2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskRelationKind(ctx context.Context, v any) (model.TaskRelationKind, error) {
	var res model.TaskRelationKind
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNTaskRelationKind2githubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskRelationKind(ctx context.Context, sel ast.SelectionSet, v model.TaskRelationKind) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) marshalOFeedbackContext2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐFeedbackContext(ctx context.Context, sel ast.SelectionSet, v *model.FeedbackContext) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._FeedbackContext(ctx, sel, v)
}
...
func (ec *executionContext) marshalOTaskCategory2ᚖgithubᚗcomᚋbcnelsonᚋtendantᚋservicesᚋapiᚋgraphᚋmodelᚐTaskCategory(ctx context.Context, sel ast.SelectionSet, v *model.TaskCategory) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._TaskCategory(ctx, sel, v)
