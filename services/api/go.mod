module github.com/bcnelson/tendant/services/api

go 1.25.7

// Workspace-local db module (`use ./db` in go.work). Replace directive keeps
// `go mod tidy` working per-module — tidy isn't workspace-aware the way go
// build is, and without this it would try to fetch the pseudo-version from
// the network.
